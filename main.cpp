...
void Buy()
{
    ...
    cout << "\033[1;31m" << "상품을 장바구니에 담으시겠습니까? (Y/N) : " << "\033[0m";
    cin >> c;
    switch (c)
    {
    case 'N':
    ...
    case 'y':
    {
        while (num != 0)
        {
            cout << "\033[1; 31m" << "상품 선택을 종료하시려면 '0'을 누르세요" << "\033[0m" << endl;
            cout << "\033[1; 31m" << "상품 선택 : " << "\033[0m";
            cin >> num;
            if (num < 0 || num>20)
            {
                cout << "\033[1;31m" << "없는 상품 번호입니다." << "\033[0m" << endl << endl;
                continue;
            }
            for (int i = 0; i < 5; i++) {
    ...
    break;
    default:
        cout << "\033[1;31m" << "잘못 입력하셨습니다. " << "\033[0m" << endl << endl;
        break;
    }
}
...
void Show_Kategorie()
{
    ...
    cout << "3. 바지" << endl;
    cout << "4. 신발" << endl;
    cout << "\033[1;31m" << "카테고리를 선택해주세요 : " << "\033[0m";
    cin >> select;
    system("cls");
    ...
    case 4:
        ...
        break;
    default:
        cout << "\033[1;31m" << "잘못 입력하셨습니다." << "\033[0m" << endl;
...
void Payment()
{
    ...
    while (true)
    {
        if (total == 0)
        {
            cout << "\033[1;31m" << "선택한 상품이 없습니다" << "\033[0m" << endl << endl;
            break;
        }

        cout << "결제 금액 : " << total << "원" << endl;
        cout << "\033[1;31m" << "얼마를 내시겠습니까? " << "\033[0m";
        cin >> pay;
        ...
        if (pay >= total)
        {
            ...
            total = 0;
            cout << "\033[1;31m" << "결제가 완료되었습니다." << "\033[0m" << endl << endl;
            cout << "--------------------------------------------" << endl << endl;
            vb.clear();
            break;
        }
        ...
        {
            total -= pay;
            cout << total << "\033[1;31m" << "원이 부족합니다." << "\033[0m" << endl << endl;
            cout << "--------------------------------------------" << endl << endl;
        }
    }
}
...
void Menu()
{
    while (1)
    {
        ...
        cout << "5. 결제하기 " << endl;
        cout << "0. 종료" << endl;
        cout << "\033[1;31m" << "메뉴를 골라주세요 : " << "\033[0m";
        int select;
        cin >> select;
